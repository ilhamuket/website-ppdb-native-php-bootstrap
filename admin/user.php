                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <form method="post">
                                                ...
                                                <td><input type="submit" class="btn btn-danger btn-sm" name="hapus"
                                                        value="Hapus">
                                                    <button type="button" class="btn btn-warning btn-sm"
                                                        data-toggle="modal"
                                                        data-target="#edit<?php echo $userid ?>">Edit</button>

                                                    <!-- Modal -->
                                                    <div class="modal fade" id="edit<?php echo $userid ?>"
                                                        role="dialog">
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <input type="email" name="emailbaru"
                                                                        value="<?php echo $em ?>" class="form-control"
                                                                        placeholder="Password" required>
                                                                    <br>
                                                                    <input type="password" name="passwordbaru"
                                                                        value="<?php echo $pw ?>" class="form-control"
                                                                        placeholder="Password" required>
                                                                    <br>
