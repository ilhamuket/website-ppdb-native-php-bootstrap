    ...
    if($role!=='Admin'){
        header("location:../login.php");
                                                ...
                                                if(isset($_POST['sukses'])){
                                                    $stat = $_POST['sukses'];
                                                    $user = $_POST['iduser'];
                                                    $queryupdate = mysqli_query($conn,"update userdata set setatus='$stat' where userid='$user'");
                                                    if($queryupdate){
                                                        //berhasil bikin
                                                      ...
                                                      <meta http-equiv='refresh' content='1; url= form.php'/>  ";  
                                                        ...
                                                        echo "<div class='alert alert-warning'>
                                                              Gagal update. Silakan coba lagi nanti.
                                                          </div>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="diterima.php"><i class="ti-layout"></i><span>Siswa Diterima</span></a>
                            </li>
                            <li>
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
										 ...
										 <table id="dataTable3" class="table table-hover" style="width:100%"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($form)){
												...
												<tr>
                                                    ...
                                                    <td><?php echo $b['setatus'] ?></td><form method="post">
                                                        <input type="hidden" value="<?php echo $b['userid'] ?>" name="iduser"></td>
                                                    <td><a class="btn btn-primary btn-sm" href="view.php?u=<?php echo $b['userid'];?>">Lihat Detail</a>
                                                  <input type="submit" class="btn btn-success btn-sm" name="sukses" value="Diterima">
                                                  <input type="submit" class="btn btn-danger btn-sm" name="gagal" value="Belum Berhasil">
                                                </td>
                                                </form>
												</tr>		
												<?php 
									...
									<a href="exportformulir.php" target="_blank" class="btn btn-info">Export Data</a>
                                                ...
                                                if(isset($_POST['sukses'])){
                                                    $user = $_POST['iduser'];
                                                    $query = mysqli_query($conn,"UPDATE userdata SET setatus='Diterima' WHERE userid='$user'");
                                                    if($query){
                                                        //berhasil bikin
                                                          echo " <div class='alert alert-success'>
                                                          Berhasil verif data.
                                                      ...
                                                      <meta http-equiv='refresh' content='1; url= form.php'/>  ";  
                                                        ...
                                                        echo "<div class='alert alert-warning'>
                                                              Gagal verif data. Silakan coba lagi nanti.
                                                          </div>
                                                          <meta http-equiv='refresh' content='3; url= form.php'/> ";
                                                      }
                                                }
                                                if(isset($_POST['gagal'])){
                                                    $query = mysqli_query($conn,"insert into userdata(status2), values='gagal' where userid='$user'");
                                                    if($query){
                                                        //berhasil bikin
                                                          echo " <div class='alert alert-success'>
                                                          Berhasil verif data.
