                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Admin Baru</button>
										 ...
										 <table id="dataTable3" class="table table-hover" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$form=mysqli_query($conn,"SELECT * FROM admin");
											$no=1;
											while($b=mysqli_fetch_array($form)){
												...
												<tr>
                                                    ...
                                                    <td><input type="submit" class="btn btn-danger btn-sm" name="hapus" value="Hapus">
                                                    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?php echo $adminid?>">Edit</button>

                                                    <!-- Modal -->
                                                    <div class="modal fade" id="edit<?php echo $adminid?>" role="dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <input type="email" name="emailbaru" value="<?php echo $em ?>" class="form-control" placeholder="Password" required>
                                                            <br>
                                                            <input type="password" name="passwordbaru" value="<?php echo $pw ?>" class="form-control" placeholder="Password" required>
                                                            <br>
                                                            <input type="hidden" value="<?php echo $adminid?>" name="idadmin">
                                                ...
                                                if(isset($_POST['updateadmin'])){
                                                    ...
                                                    $admin = $_POST['idadmin'];
                                                    $queryupdate = mysqli_query($conn,"update admin set adminemail='$emailbaru', adminpassword='$passwordbaru' where adminid='$admin'");
                                                    if($queryupdate){
                                                        //berhasil bikin
                                                          echo " <div class='alert alert-success'>
