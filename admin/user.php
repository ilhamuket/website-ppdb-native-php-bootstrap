										 ...
										 <table id="dataTable3" class="table table-hover" style="width:100%"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($form)){
												...
												<tr>
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?php echo $userid?>">Edit</button>

                                                    <!-- Modal -->
                                                    <div class="modal fade" id="edit<?php echo $userid?>" role="dialog">
                                                ...
                                                if(isset($_POST['updateuser'])){
                                                    ...
                                                    $user = $_POST['iduser'];
                                                    $queryupdate = mysqli_query($conn,"update user set useremail='$emailbaru', userpassword='$passwordbaru' where userid='$user'");
                                                    if($queryupdate){
                                                        //berhasil bikin
                                                          echo " <div class='alert alert-success'>
